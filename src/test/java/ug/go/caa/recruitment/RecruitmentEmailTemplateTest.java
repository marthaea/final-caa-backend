...
class RecruitmentEmailTemplateTest {
    ...
    void layoutIncludesBrandingAndButton() {
        String html = RecruitmentEmailTemplate.layout(
                ...
                "https://recruitfront.netlify.app/caa-logo.png");
        ...
        assertThat(html).contains("https://recruitfront.netlify.app/caa-logo.png");
        assertThat(html).contains("https://example.org/verify?token=abc");
    }

    @Test
    void escapesPlainTextInGreeting() {
        String html = RecruitmentEmailTemplate.greeting("<script>alert(1)</script>");
